...
function ajaxViewDetail(id , url) {
	...
	$.get(url ,function(data) {
		...
		$.alert({title: 'Ошибка!',content: xhr.responseText,type: 'red',columnClass:'col-md-7'});
		$('.ajaxLoading').hide();
	});
...
{
	$('#sximo-modal-lg #sximo-modal-content').html(' ... Подождите немного, идёт загрузка данных ...');
