...
jQuery(document).ready(function($){
	...
	$('.datetime').datetimepicker({format: 'dd-mm-yyyy hh:ii:ss'});
...
function JView(url, title, size) {
    size = typeof size !== 'undefined' && size!='' ?  size : 'medium';
    $.alert({
        icon: 'fa fa-info',
        animation: 'rotate',
        type: 'blue',
...
{
	$('#sximo-modal-content').html(' ... Подождите немного, идёт загрузка данных ...');
