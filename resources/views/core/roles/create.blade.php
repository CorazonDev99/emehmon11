        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('roles.store') }}" method="POST">
                    @csrf
                    <div class="mb-4">
                        <label for="role-name" class="form-label"><strong>Role name:</strong></label>
                        <input id="role-name" type="text" name="name" class="form-control" placeholder="Enter the role name" value="{{ old('name') }}">
                    </div>
                        ...
                        <table class="table table-bordered table-hover align-middle">
                            ...
                            @foreach($modules as $index => $module)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="checkbox-wrapper-19">
                                            <input type="checkbox" name="permissions[{{ $module->module_id }}][view]" value="1" id="view-{{ $module->module_id }}" class="inp-cbx">
                                            <label for="view-{{ $module->module_id }}" class="check-box"></label>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="checkbox-wrapper-19">
                                            <input type="checkbox" name="permissions[{{ $module->module_id }}][create]" value="1" id="create-{{ $module->module_id }}" class="inp-cbx">
                                            <label for="create-{{ $module->module_id }}" class="check-box"></label>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="checkbox-wrapper-19">
                                            <input type="checkbox" name="permissions[{{ $module->module_id }}][read]" value="1" id="read-{{ $module->module_id }}" class="inp-cbx">
                                            <label for="read-{{ $module->module_id }}" class="check-box"></label>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="checkbox-wrapper-19">
                                            <input type="checkbox" name="permissions[{{ $module->module_id }}][edit]" value="1" id="edit-{{ $module->module_id }}" class="inp-cbx">
                                            <label for="edit-{{ $module->module_id }}" class="check-box"></label>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="checkbox-wrapper-19">
                                            <input type="checkbox" name="permissions[{{ $module->module_id }}][delete]" value="1" id="delete-{{ $module->module_id }}" class="inp-cbx">
