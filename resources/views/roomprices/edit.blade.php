            ...
            <div class="row mx-auto">
                <div class="col-md-8 mx-auto">
                    <div class="mb-3 d-flex ">
                        ...
                        <span class="form-control bg-success">{{ $data->hotel_name }}</span>
                    </div>
                </div>
                <div class="col-md-8 mx-auto">
                    <div class="mb-3 d-flex">
                        <label class="customWidth" for="dt">DATE</label>
                        <input value="{{ $data->dt }}" required autocomplete="off" class="form-control"
                            name="dt" type="date" id="dt" required min="<?php echo date('Y-m-d'); ?>"
                    ...
                    <div class="mb-3 d-flex">
                        ...
                        <select id="id_type" name="id_type" class="form-select" required>
                            ...
                            @foreach ($roomTypes as $roomType)
                                <option value="{{ $roomType->id }}" @if ($roomType->id == $data->id_type) selected @endif>
                                    {{ $roomType->en }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="mb-3 d-flex">
                        ...
                        <input type="number" class="form-control" name="beds" value="{{ $data->beds }}">
                    </div>
                </div>
                <div class="col-md-8 mx-auto">
                    <div class="mb-3 d-flex">
                        <label class="customWidth" for="people">PEOPLE</label>
                ...
                <div class="col-md-8 mx-auto">
                    <div class="mb-3 d-flex">
                        ...
                        <input type="number" class="form-control" name="uzs" value="{{ $data->uzs }}">
                    </div>
                </div>
                <div class="col-md-8 mx-auto">
                    <div class="mb-3 d-flex">
                        <label class="customWidth" for="usd">PRICE USD</label>
                        <input type="number" class="form-control" name="usd" value="{{ $data->usd }}">
                    </div>
                </div>
                <div class="col-md-8 mx-auto">
                    <div class="mb-3 d-flex">
                        <div class="form-group">
                            ...
                            <label class="switch">
                                <input type="checkbox" name="breakfast" value="1" id="breakfast-checkbox"
                                    @if ($data->breakfast) checked @endif>
